	...
	<main class="wrapper sb-default">
			...
			<div class="mn-header">
				<div class="mn-header-items">
					<div class="left-header">
						...
						<a href="{{ route('web.index') }}" class="logo"><img src="{{ asset('storage/' . $settings->logo_path) }}" alt="logo"></a>
								...
								<div class="footer-copy">
									<div class="footer-bottom-copy ">
										<div class="mn-copy">Copyright © <span id="copyright_year"></span>
											<a class="site-name" href="index-2.html">The Mantu</a> all rights reserved.
										</div>
									</div>
								</div>
		...
		<div class="mn-footer-nav">
			<ul>
				...
				<li>
					<a href="index-2.html" class="mn-toggle-menu">
						<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0"
